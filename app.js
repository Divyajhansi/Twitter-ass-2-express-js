...
//API4 all the people who the logged user if following
...
//API5 get all the followers of the logged in user
...
//API7 get all likes of a tweet with tweet id if the user follows the tweeter
...
//API8 get all replies of a tweet with tweet id if the user follows the tweeter
...
// get all the tweet by the logged user API9
...
// post a tweet by the logged in user API10
